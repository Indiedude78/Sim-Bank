...
<div class="form-container">
    ...
    <form id="withdraw-form" method="GET">
...
<div class="form-container">
    <?php if (isset($_GET["search"]) && $_GET["account_number"] != "None") : ?>
        <form id="withdraw-searched-form" method="GET">
            <label for="acc_num"><?php safer_echo("Account: " . $_GET["account_number"]); ?></label>
            ...
            <div>
                <label>$ </label><input type="number" id="withdraw_amount" name="withdraw_amount" min="1" step="any" placeholder="Withdraw Amount" required />
            </div>
